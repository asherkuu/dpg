google.maps._gjsload_('overlay', function(_) {
    var Ex = _.oa("i")
      , Fx = _.n()
      , Gx = function(a) {
        a.ih = a.ih || new Fx;
      ...
      , Lx = function(a) {
        if (a) {
            ...
            if (b && b instanceof _.Fg) {
                var d = b._gm;
                d.overlayLayer ? a._gmop = new Jx(b,a,d.overlayLayer) : d.i.then(function(e) {
                    e = e.rb;
                    var f = new Kx(b,e);
                    e.yc(f);
                    d.overlayLayer = f;
      ...
      , Mx = function(a, b) {
        a.mb.get("projection") != b && (a.mb.bindTo("panes", a.map._gm),
    ...
    _.ef("overlay", {
        Mh: function(a) {
            if (a) {
                var b = a.getMap();
                if (b && b instanceof _.Fg || a._gmop)
                    Lx(a);
                else {
                    b = a.getMap();
                    var c = Gx(a)
